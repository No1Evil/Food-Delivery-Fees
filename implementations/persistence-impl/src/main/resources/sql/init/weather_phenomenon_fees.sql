...
insert into weather_phenomenon_fees (id, vehicle_type_id, weather_phenomenon, fee)
VALUES ( 1,2, 'snow', 1 );
...
insert into weather_phenomenon_fees (id, vehicle_type_id, weather_phenomenon, fee, is_allowed)
