...
public interface MeasurementRepository extends Repository<Measurement> {
    ...
    Optional<Measurement> findLatest(RegionName regionName, Instant timestamp);

    /** {@return found measurement list}  */
    List<Measurement> findAllByTime(Instant from, Instant to);

    /** {@return found measurement or Empty}  */
    Optional<Measurement> findRegionNameAndTime(RegionName regionName, Instant from, Instant to);
}
